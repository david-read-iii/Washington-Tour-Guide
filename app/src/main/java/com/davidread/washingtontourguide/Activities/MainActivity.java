...
public class MainActivity extends AppCompatActivity {
    ...
    private ArrayList<Category> getCategoriesArrayList() {
        ...
        restaurants.add(new Place("Empanada Mamasita", "65 E Washington Ave", "Latin comfort food."));
        restaurants.add(new Place("Washington Diner", "6 NJ-31", "The key to our success is simple: providing quality consistent food that taste great every single time. We pride ourselves on serving our customers delicious genuine dishes like: American."));

        ArrayList<Place> businesses = new ArrayList<>();
        businesses.add(new Place("Dave's Friendly Services Inc", "288 W Washington Ave", "Welcome to Dave's Friendly Service! We are a full service, automotive repair and maintenance shop serving the Washington area since 1976. We understand that sometimes car repair can be stressful and we do everything possible to make our customers feel welcome, comfortable and satisfied with their service experience. We make your service experience hassle-free. We are happy to offer early bird and night-owl drop-box service and local shuttle service to your home or office."));
        businesses.add(new Place("Warren County Liquors LLC", "260 W Washington Ave", "Fine liquor, wine, spirits, and beer."));
        ...
        businesses.add(new Place("M Y Accounting and Tax Services", "111 W Washington Ave", "They do taxes and stuff. Idk."));
        businesses.add(new Place("Albea Americas, Inc", "191 NJ-31", "Big company with no website to get info from. Not sure what they do. Lol."));

        ArrayList<Place> religiousPlaces = new ArrayList<>();
        religiousPlaces.add(new Place("Faith Discovery Church", "33 Brass Castle Rd", "Here at FDC we have three Core Values by which we strive to live. Authentic, be real! Accepting, be loving! Accelerating, be encouraging!"));
        religiousPlaces.add(new Place("United Methodist Church", "116 E Washington Ave", "Greenstone is a welcoming and affirming community of faith located in the heart of Downtown Washington, NJ. We are thrilled to provide you with a Christ centered experience and an environment to nurture your spirit or raise a family."));
        religiousPlaces.add(new Place("First Presbyterian Church", "40 E Church St", "Orange Presbyterian church."));
        religiousPlaces.add(new Place("St. Joseph Roman Catholic Church", "200 Carlton Ave", "Welcome! And thank you for visiting our Parish web site. The pages of this site speak of a humble and proud family. Humble in our beginning and reality of who we are before God, and proud to be a people doing his work for over 140 years. As you scroll through these pages please keep us in your prayers as we will remember you."));
        ...
        funPlaces.add(new Place("Roaring Rock Park", "Harmony Brass Castle Rd", "Hiking trail up by Brass Castle Road."));
        funPlaces.add(new Place("Von Thun Farms", "438 NJ-57", "Nestled in scenic Warren County, VonThun Farms is open spring, summer, and fall with events and activities for the whole family! Visit the New Jersey Sunflower Trail, New Jersey’s premier sunflower destination. Stop into our farm market for homegrown fruits, vegetables and angus beef and pick your own strawberries, raspberries, blackberries, peaches, apples and pumpkins."));
        funPlaces.add(new Place("Pohatcong Native Arboretum", "52 Mine Hill Rd", "Pohatcong Native Arboretum, Native Tree Museum of New Jersey, has an exhibition on display of over 155 species of native trees, shrubs, and vines. The plants are identified by plaques with common, family, genus, and species names. Between 2010 and 2015 our plant collection was tripled."));
        funPlaces.add(new Place("Washington Borough Pocket Park", "44 E Washington Ave", "Small park nestled between some businesses in the boro."));

        ArrayList<Place> schools = new ArrayList<>();
        schools.add(new Place("Taylor Street School", "16 Taylor St #24", "Taylor Street Elementary School is a public school located in Washington, NJ, which is in a fringe town setting.The student population of Taylor Street Elementary School is 188, and the school serves PK-2."));
